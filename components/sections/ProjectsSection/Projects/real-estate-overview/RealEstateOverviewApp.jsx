...
const RealEstateOverviewProject = ({ title, summary, impact="" }) => {
    ...
    const data = {
        ...
        backendInfo: "Netlify serverless functions all query data from the US Census Bureau API, and the Google Sheets API. It also caches static queries using a redis cloud instance, with the Upstash-Redis platform.",
        ...
        about: `It was really cool getting to understand the ins and outs of NextJS. I learned how it is particularly geared towards SEO optimization and creating a great user experience. The built in features like lazy loading images, and even lazy loading components was somewhat new to me, and is now a great tool in my toolbelt.`,
        about2: `Integrating with the government APIs was challenging (think HTML-only tables for documentation). I had to troubleshoot this problem by joining a slack community centered on the US Census API. To increase performance, I put into practice what I have learned through a systems design course I'm taking: optimize common queries using a cache. Reading from in-memory caches is 75% faster than reading from a database. I came across "Upstash-Redis", which is essentially Redis in the cloud, accessible through HTTP protocol, instead of TCP. Super useful tool.`,
